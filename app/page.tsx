    ...
    <>
      ...
      bg-yellow-400 text-black rounded-full shadow-sm"
            ...
            <p className="text-gray-700 text-lg max-w-3xl mb-16">
              PrepBuddy AI is not a collection of tools. It’s an AI-first
              platform that continuously evaluates, guides, and improves
              students across interviews, communication, aptitude, and technical
              readiness — with expert support where it matters most.
            </p>
      ...
      bg-yellow-400 text-black rounded-full"
            ...
            <p className="text-gray-300 text-lg max-w-3xl mb-16">
              ...
              placement preparation, replacing scattered effort with
              intelligent, structured execution.
            </p>
        ...
        bg-yellow-400 text-black rounded-full"
              ...
              <p className="text-lg text-gray-700 leading-relaxed max-w-xl">
                ...
                fail because preparation is unstructured, feedback is delayed,
                and confidence is left to chance.
              </p>
        ...
        group-hover:-top-4 group-hover:-left-4 transition-all duration-300"
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed mb-8">
                  ...
                  Vaishnavi brings together academic rigor, corporate
                  experience, and a deep understanding of student challenges to
                  build India’s most advanced AI-powered placement and
      ...
      bg-yellow-400 text-black rounded-full"
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-12">
              Move beyond one-size-fits-all training. Give your students an
              AI-led preparation system that adapts, guides, and delivers
              measurable outcomes.
            </p>
