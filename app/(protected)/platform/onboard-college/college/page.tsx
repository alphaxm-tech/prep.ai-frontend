...
import { addCollege } from "@/server-api/mutations/ccg.mutations";
import { AddCollegeRequest } from "@/server-api/api/types/ccg.types";
import Loader from "@/components/Loader";
import { useToast } from "@/components/toast/ToastContext";
import { ToastStates } from "@/enums/enums";
import { COURSE, ONBOARD_COLLEGE, PLATFORM_ROUTE } from "@/constants/ui-routes";
...
export default function AddCollegePage() {
  ...
  const addCollegeMutation = addCollege();
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    const payload: AddCollegeRequest = {
    ...
    addCollegeMutation.mutate(payload, {
      ...
      onError: (err: any) => {
        ...
        showToast(ToastStates.ERROR, err?.response?.data?.error?.message);
        ...
        //     "College code already exists, please try again with a different code"
        //   ) {
        //     showToast(
        //       "error",
        //       "College code already exists, please try again with a different code",
                ...
                <aside className="space-y-4">
                  ...
                  <div className="p-4 rounded-lg bg-white border border-gray-50 shadow-sm">
                    ...
                    <div className="mt-3 text-xs text-gray-500">
                      Toggle whether this college should be active in the
                      system. You can change this later.
                    </div>
                  </div>
