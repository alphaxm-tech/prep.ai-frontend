...
const ACTIVITY = [
  {
    icon: "🏫",
    action: "New college onboarded",
    detail: "RAIT Mumbai added",
    time: "2 hrs ago",
  },
  {
    icon: "👤",
    action: "Admin invited",
    detail: "admin@nits.ac.in",
    time: "4 hrs ago",
  },
  {
    icon: "🤖",
    action: "AI model updated",
    detail: "Interview scoring v2.1",
    time: "1 day ago",
  },
  {
    icon: "👥",
    action: "Bulk import completed",
    detail: "320 students · SVNIT",
    time: "1 day ago",
  },
  {
    icon: "💼",
    action: "Placement drive closed",
    detail: "TCS · IIT Bombay",
    time: "2 days ago",
  },
  {
    icon: "📊",
    action: "Report generated",
    detail: "Q1 Platform Analytics",
    time: "3 days ago",
  },
];
...
export default function PlatformDashboard() {
  ...
  const firstName =
    auth?.user?.full_name?.split(/[, ]+/)?.filter(Boolean)[1] ?? "Super Admin";
  ...
  const kpis: {
    ...
    },
    {
      label: "AI Interviews",
      value: "45,890",
      delta: "+3.2k this week",
      color: "green",
    },
    {
      label: "Placements",
      value: "9,870",
      delta: "+890 this quarter",
      color: "rose",
    },
    {
      label: "Resume Scans",
      value: "32,100",
      delta: "+2.1k this week",
      color: "teal",
    },
  ];
  ...
  const actions = [
    ...
    },
    {
      ...
      desc: "Manage admins and placement officers",
      icon: "👥",
    ...
    },
    {
      ...
      desc: "Platform-wide performance reports",
      icon: "📊",
    ...
    },
    {
      ...
      desc: "Tune models, scoring & automation",
      icon: "🤖",
    ...
    },
    {
      ...
      desc: "System config, integrations, billing",
      icon: "⚙️",
    ...
    },
    {
      ...
      desc: "Review access logs and history",
      icon: "🔒",
  ...
  const intelligence = [
    ...
    { label: "AI Shortlist Accuracy", value: "92%", sub: "vs manual review" },
    {
      ...
      value: "84%",
      sub: "of scheduled sessions",
    },
  ];

  const handleOnboardCollege = () => {
    router.push(`${pathname}/onboard-college/college`);
  };
...
function KpiCard({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
      <div
        className={`absolute left-0 top-0 h-1 w-full bg-gradient-to-r ${bars[color]}`}
      />
...
function ActionCard({
  ...
  return (
    ...
    >
      <div
        className={`absolute left-0 top-0 h-1 w-full bg-gradient-to-r ${bar}`}
      />
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="text-xs text-gray-500">
          {college.city} · {college.students.toLocaleString()} students
        </div>
      </div>
