...
export const AI_INTERVIEW_INSTRUCTIONS = "/instructions";
export const AI_INTERVIEW_TERMINATED = "/terminated";
...
export const CODE_EDITOR_INSTRUCTIONS = "/instructions";
export const CODE_EDITOR_TERMINATED = "/terminated";
